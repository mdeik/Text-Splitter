...
A simple web app that lets users split text based on custom criteria. Built as a quick refresher on HTML and JavaScript, it was a great way to revisit text processing and UI fundamentals.
...
2.  The application then splits the input text according to the selected criteria and displays the resulting sections as buttons.
3.  When a button is clicked, its value is copied to the clipboard, and a toast notification appears.
